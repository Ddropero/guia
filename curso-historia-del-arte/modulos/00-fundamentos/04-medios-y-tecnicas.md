...
**1. (Opción múltiple)** En la técnica del *buon fresco*, el color queda fijado porque:
a) el aceite se seca al aire; b) la cal del muro, al carbonatarse, atrapa el pigmento; c) el huevo aglutina los granos; d) se aplica un barniz final.

**2. (Opción múltiple)** ¿Cuál de estos NO es un medio múltiple (reproducible en ejemplares)?
a) Xilografía; b) fotografía; c) fundición a la cera perdida; d) talla directa en mármol.

**3. (Opción múltiple)** La litografía se basa en:
a) vaciar la madera; b) incidir surcos en una plancha de cobre; c) la repulsión entre grasa y agua sobre piedra; d) teselas de vidrio.
