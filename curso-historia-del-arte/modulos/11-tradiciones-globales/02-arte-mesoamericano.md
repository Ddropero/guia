...
1. **(Opción múltiple)** ¿Cuál de estas culturas se considera la "cultura madre" de Mesoamérica, autora de las cabezas colosales de basalto?
   a) Maya. b) Mexica. c) Olmeca. d) Teotihuacana.
2. **(Opción múltiple)** El sistema constructivo de fachadas formado por un plano inclinado coronado por un panel rectangular, característico de Teotihuacán, se llama:
   a) Cera perdida. b) Talud-tablero. c) Horror vacui. d) Talud-glifo.
3. **(Opción múltiple)** La llamada "Piedra del Sol" o "Calendario azteca" es, en rigor:
   a) Un calendario de uso práctico para fechar cosechas. b) El sarcófago de un rey mexica. c) Una cosmografía sobre las eras del mundo y la deuda de sangre del Sol. d) Un mapa de Tenochtitlan.
